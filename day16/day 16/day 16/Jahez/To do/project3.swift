...
//  day 16
//
//  Created by sally asiri on 11/03/1443 AH.
//
...
var taskArray = [Task] ()
class project3: UIViewController,UITableViewDataSource,UITableViewDelegate, checkButtondelegate {
   ...
   func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    cell.setup()
     if taskArray[indexPath.row].isCompleted{
      ...
      cell.checkButton.setImage(UIImage(systemName: "plus.circle.fill"), for: .normal)
    }
     return cell
  }
